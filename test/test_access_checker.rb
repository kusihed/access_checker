...
class TestAccesChecker < Test::Unit::TestCase

 context "a user" do

    setup do
      @demarcus = FactoryBot.create( :user )
      @deshaun =  FactoryBot.create( :user )
    end
    ...
    should "raise exception if no roles" do
       assert_raise( AccesChecker::EmptyRoles ) do
         @demarcus.get_role()
       end  #  block
    end
 ...
 context "a role" do
    ...
    setup do
      ...
      @manager =  FactoryBot.create( :role,  name: "manager")
    end
